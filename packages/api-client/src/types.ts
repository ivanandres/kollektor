...
export type StatsValue = Out<Core['stats']['valueBreakdowns']>;
export type Duplicate = Out<Core['stats']['duplicates']>[number];
...
export type CsvImportResult = Out<Core['imports']['importCsv']>;
