...
export function seedLibrary(c: FakeCatalog) {
  return {
    ...
    dsotmJp: c.addRelease({
      ...
      masterId: '10362',
      country: 'Japan',
      labels: [{ name: 'Odeon', catno: 'EMS-80324' }],
      genres: ['Rock'],
      styles: ['Prog Rock'],
    ...
    animals: c.addRelease({
      ...
      masterId: '10414',
      country: 'UK',
      labels: [{ name: 'Harvest', catno: 'SHVL 815' }],
      styles: ['Prog Rock'],
      tracks: [
    ...
    foreverChanges: c.addRelease({
      ...
      masterId: '47680',
      country: 'US',
      labels: [{ name: 'Elektra', catno: 'EKS-74013' }],
      genres: ['Rock'],
    ...
    imagine: c.addRelease({
      ...
      masterId: '4745',
      country: 'UK',
      labels: [{ name: 'Apple Records', catno: 'PAS 10004' }],
      genres: ['Rock', 'Pop'],
      styles: ['Pop Rock'],
      tracks: [
        ['A1', 'Imagine'],
    ...
    magical: c.addRelease({
      ...
      masterId: '46402',
      country: 'US',
      labels: [{ name: 'Capitol Records', catno: 'SMAL 2835' }],
      genres: ['Rock', 'Pop'],
    ...
    kindOfBlue: c.addRelease({
      ...
      country: 'Japan',
      masterYear: 1959,
      labels: [{ name: 'CBS/Sony', catno: '20AP 1401' }],
      genres: ['Jazz'],
      styles: ['Modal', 'Cool Jazz'],
      formats: [
        { name: 'Vinyl', descriptions: ['LP', 'Album', 'Reissue', 'Limited Edition'], text: 'Red' },
      ],
      tracks: [
        ['A1', 'So What'],
    ...
    ledZep: c.addRelease({
      ...
      masterId: '7004',
      country: 'UK',
      labels: [{ name: 'Atlantic', catno: '588198' }],
